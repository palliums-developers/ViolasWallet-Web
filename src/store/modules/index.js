...
import { getBTCDealRecord, checkNewCoin, updateCoin, startCurLTranfer, getCurUserInfo, createUserInfo, getCurBalance, getCurCoinMess, getLibraDealRecord, addressMessage, getViolasDealRecord, get_stable_coin_list } from '../../api/server'
...
export default class Index {
    ...
    getAddress3(params) {
        this.type2 = params.type;
        this.sweepCode2 = params.address;
    }
    //创建用户信息
    ...
    //查询稳定币交易
    @action async stable_coin_list(params){
        let result=await get_stable_coin_list(params);
