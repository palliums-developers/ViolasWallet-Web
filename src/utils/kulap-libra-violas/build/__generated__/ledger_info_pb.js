...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.types.LedgerInfo.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            nextValidatorSet: (f = msg.getNextValidatorSet()) && validator_set_pb.ValidatorSet.toObject(includeInstance, f)
        };
        if (includeInstance) {
...
proto.types.LedgerInfo.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getNextValidatorSet();
    if (f != null) {
        writer.writeMessage(7, f, validator_set_pb.ValidatorSet.serializeBinaryToWriter);
    }
};
/**
 ...
 * @return {number}
 */
proto.types.LedgerInfo.prototype.getEpoch = function () {
    return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 5, 0));
};
/** @param {number} value */
proto.types.LedgerInfo.prototype.setEpoch = function (value) {
...
/**
 * optional ValidatorSet next_validator_set = 7;
 * @return {?proto.types.ValidatorSet}
 */
proto.types.LedgerInfo.prototype.getNextValidatorSet = function () {
    return /** @type{?proto.types.ValidatorSet} */ (jspb.Message.getWrapperField(this, validator_set_pb.ValidatorSet, 7));
};
/** @param {?proto.types.ValidatorSet|undefined} value */
proto.types.LedgerInfo.prototype.setNextValidatorSet = function (value) {
    jspb.Message.setWrapperField(this, 7, value);
};
proto.types.LedgerInfo.prototype.clearNextValidatorSet = function () {
    this.setNextValidatorSet(undefined);
};
/**
 * Returns whether this field is set.
 * @return {boolean}
 */
proto.types.LedgerInfo.prototype.hasNextValidatorSet = function () {
