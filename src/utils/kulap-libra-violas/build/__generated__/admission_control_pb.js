...
proto.admission_control.AdmissionControlMsg.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(1, f, proto.admission_control.SubmitTransactionRequest.serializeBinaryToWriter);
    }
    f = message.getSubmitTransactionResponse();
    if (f != null) {
        writer.writeMessage(2, f, proto.admission_control.SubmitTransactionResponse.serializeBinaryToWriter);
    }
};
/**
...
proto.admission_control.AdmissionControlMsg.prototype.getSubmitTransactionRequest = function () {
    return /** @type{?proto.admission_control.SubmitTransactionRequest} */ (jspb.Message.getWrapperField(this, proto.admission_control.SubmitTransactionRequest, 1));
};
...
proto.admission_control.AdmissionControlMsg.prototype.getSubmitTransactionResponse = function () {
    return /** @type{?proto.admission_control.SubmitTransactionResponse} */ (jspb.Message.getWrapperField(this, proto.admission_control.SubmitTransactionResponse, 2));
};
...
proto.admission_control.SubmitTransactionResponse.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(1, f, vm_errors_pb.VMStatus.serializeBinaryToWriter);
    }
    f = message.getAcStatus();
    if (f != null) {
        writer.writeMessage(2, f, proto.admission_control.AdmissionControlStatus.serializeBinaryToWriter);
    }
    f = message.getMempoolStatus();
    if (f != null) {
        writer.writeMessage(3, f, mempool_status_pb.MempoolAddTransactionStatus.serializeBinaryToWriter);
    }
...
proto.admission_control.SubmitTransactionResponse.prototype.getVmStatus = function () {
    return /** @type{?proto.types.VMStatus} */ (jspb.Message.getWrapperField(this, vm_errors_pb.VMStatus, 1));
};
...
proto.admission_control.SubmitTransactionResponse.prototype.getAcStatus = function () {
    return /** @type{?proto.admission_control.AdmissionControlStatus} */ (jspb.Message.getWrapperField(this, proto.admission_control.AdmissionControlStatus, 2));
};
...
proto.admission_control.SubmitTransactionResponse.prototype.getMempoolStatus = function () {
    return /** @type{?proto.mempool_status.MempoolAddTransactionStatus} */ (jspb.Message.getWrapperField(this, mempool_status_pb.MempoolAddTransactionStatus, 3));
};
