...
proto.types.AccumulatorProof.prototype.getSiblingsList_asB64 = function () {
    return /** @type {!Array<string>} */ (jspb.Message.bytesListAsB64(this.getSiblingsList()));
};
/**
 * repeated bytes siblings = 1;
...
proto.types.AccumulatorProof.prototype.getSiblingsList_asU8 = function () {
    return /** @type {!Array<!Uint8Array>} */ (jspb.Message.bytesListAsU8(this.getSiblingsList()));
};
...
proto.types.AccumulatorConsistencyProof.prototype.getSubtreesList_asB64 = function () {
    return /** @type {!Array<string>} */ (jspb.Message.bytesListAsB64(this.getSubtreesList()));
};
/**
 * repeated bytes subtrees = 1;
 * Note that Uint8Array is not supported on all browsers.
...
proto.types.AccumulatorConsistencyProof.prototype.getSubtreesList_asU8 = function () {
    return /** @type {!Array<!Uint8Array>} */ (jspb.Message.bytesListAsU8(this.getSubtreesList()));
};
/** @param {!(Array<!Uint8Array>|Array<string>)} value */
...
proto.types.AccumulatorRangeProof.prototype.getLeftSiblingsList_asB64 = function () {
    return /** @type {!Array<string>} */ (jspb.Message.bytesListAsB64(this.getLeftSiblingsList()));
};
/**
 * repeated bytes left_siblings = 1;
 * Note that Uint8Array is not supported on all browsers.
...
proto.types.AccumulatorRangeProof.prototype.getLeftSiblingsList_asU8 = function () {
    return /** @type {!Array<!Uint8Array>} */ (jspb.Message.bytesListAsU8(this.getLeftSiblingsList()));
};
/** @param {!(Array<!Uint8Array>|Array<string>)} value */
...
proto.types.AccumulatorRangeProof.prototype.getRightSiblingsList_asB64 = function () {
    return /** @type {!Array<string>} */ (jspb.Message.bytesListAsB64(this.getRightSiblingsList()));
};
/**
 * repeated bytes right_siblings = 2;
 * Note that Uint8Array is not supported on all browsers.
...
proto.types.AccumulatorRangeProof.prototype.getRightSiblingsList_asU8 = function () {
    return /** @type {!Array<!Uint8Array>} */ (jspb.Message.bytesListAsU8(this.getRightSiblingsList()));
};
/** @param {!(Array<!Uint8Array>|Array<string>)} value */
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.types.TransactionListProof.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            transactionInfosList: jspb.Message.toObjectList(msg.getTransactionInfosList(), transaction_info_pb.TransactionInfo.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.types.TransactionListProof.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(1, f, proto.types.AccumulatorRangeProof.serializeBinaryToWriter);
    }
...
proto.types.TransactionListProof.prototype.getLedgerInfoToTransactionInfosProof = function () {
    return /** @type{?proto.types.AccumulatorRangeProof} */ (jspb.Message.getWrapperField(this, proto.types.AccumulatorRangeProof, 1));
};
