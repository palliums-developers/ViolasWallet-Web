...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.types.ValidatorPublicKeys.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            consensusVotingPower: jspb.Message.getFieldWithDefault(msg, 3, 0),
    ...
    while (reader.nextField()) {
        ...
        switch (field) {
            ...
            case 3:
                ...
                msg.setConsensusVotingPower(value);
                break;
            case 4:
                var value = /** @type {!Uint8Array} */ (reader.readBytes());
...
proto.types.ValidatorPublicKeys.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getConsensusVotingPower();
    if (f !== 0) {
...
proto.types.ValidatorPublicKeys.prototype.getConsensusPublicKey_asB64 = function () {
    return /** @type {string} */ (jspb.Message.bytesAsB64(this.getConsensusPublicKey()));
};
/**
 * optional bytes consensus_public_key = 2;
 * Note that Uint8Array is not supported on all browsers.
...
proto.types.ValidatorPublicKeys.prototype.getConsensusPublicKey_asU8 = function () {
    return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getConsensusPublicKey()));
};
/** @param {!(string|Uint8Array)} value */
...
/**
 * optional uint64 consensus_voting_power = 3;
 * @return {number}
 */
proto.types.ValidatorPublicKeys.prototype.getConsensusVotingPower = function () {
    return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
/** @param {number} value */
proto.types.ValidatorPublicKeys.prototype.setConsensusVotingPower = function (value) {
    jspb.Message.setProto3IntField(this, 3, value);
};
/**
 * optional bytes network_signing_public_key = 4;
 * @return {!(string|Uint8Array)}
 */
...
proto.types.ValidatorPublicKeys.prototype.getNetworkSigningPublicKey_asB64 = function () {
    return /** @type {string} */ (jspb.Message.bytesAsB64(this.getNetworkSigningPublicKey()));
};
/**
 * optional bytes network_signing_public_key = 4;
 * Note that Uint8Array is not supported on all browsers.
...
proto.types.ValidatorPublicKeys.prototype.getNetworkSigningPublicKey_asU8 = function () {
    return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getNetworkSigningPublicKey()));
};
/** @param {!(string|Uint8Array)} value */
...
/**
 * optional bytes network_identity_public_key = 5;
 * @return {!(string|Uint8Array)}
 */
...
proto.types.ValidatorPublicKeys.prototype.getNetworkIdentityPublicKey_asB64 = function () {
    return /** @type {string} */ (jspb.Message.bytesAsB64(this.getNetworkIdentityPublicKey()));
};
/**
 * optional bytes network_identity_public_key = 5;
 * Note that Uint8Array is not supported on all browsers.
...
proto.types.ValidatorPublicKeys.prototype.getNetworkIdentityPublicKey_asU8 = function () {
    return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getNetworkIdentityPublicKey()));
};
/** @param {!(string|Uint8Array)} value */
