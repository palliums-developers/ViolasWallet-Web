...
proto.types.SignedTransaction.prototype.getTxnBytes_asB64 = function () {
    return /** @type {string} */ (jspb.Message.bytesAsB64(this.getTxnBytes()));
};
/**
 * optional bytes txn_bytes = 5;
...
proto.types.SignedTransaction.prototype.getTxnBytes_asU8 = function () {
    return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getTxnBytes()));
};
...
proto.types.Transaction.prototype.getTransaction_asB64 = function () {
    return /** @type {string} */ (jspb.Message.bytesAsB64(this.getTransaction()));
};
/**
 * optional bytes transaction = 1;
 * Note that Uint8Array is not supported on all browsers.
...
proto.types.Transaction.prototype.getTransaction_asU8 = function () {
    return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getTransaction()));
};
/** @param {!(string|Uint8Array)} value */
...
proto.types.TransactionWithProof.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(2, f, proto.types.Transaction.serializeBinaryToWriter);
    }
    f = message.getProof();
    if (f != null) {
        writer.writeMessage(3, f, proof_pb.TransactionProof.serializeBinaryToWriter);
    }
    f = message.getEvents();
    if (f != null) {
...
proto.types.TransactionWithProof.prototype.getTransaction = function () {
    return /** @type{?proto.types.Transaction} */ (jspb.Message.getWrapperField(this, proto.types.Transaction, 2));
};
...
proto.types.TransactionWithProof.prototype.getProof = function () {
    return /** @type{?proto.types.TransactionProof} */ (jspb.Message.getWrapperField(this, proof_pb.TransactionProof, 3));
};
...
proto.types.TransactionToCommit.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getTransaction();
    if (f != null) {
        writer.writeMessage(1, f, proto.types.Transaction.serializeBinaryToWriter);
    }
...
proto.types.TransactionToCommit.prototype.getTransaction = function () {
    return /** @type{?proto.types.Transaction} */ (jspb.Message.getWrapperField(this, proto.types.Transaction, 1));
};
/** @param {?proto.types.Transaction|undefined} value */
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.types.TransactionListWithProof.toObject = function (includeInstance, msg) {
        var f, obj = {
            transactionsList: jspb.Message.toObjectList(msg.getTransactionsList(), proto.types.Transaction.toObject, includeInstance),
...
proto.types.TransactionListWithProof.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getTransactionsList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.types.Transaction.serializeBinaryToWriter);
    }
    f = message.getEventsForVersions();
    if (f != null) {
        writer.writeMessage(2, f, events_pb.EventsForVersions.serializeBinaryToWriter);
    }
    ...
    f = message.getProof();
    if (f != null) {
        writer.writeMessage(4, f, proof_pb.TransactionListProof.serializeBinaryToWriter);
    }
};
/**
...
proto.types.TransactionListWithProof.prototype.getTransactionsList = function () {
    return /** @type{!Array<!proto.types.Transaction>} */ (jspb.Message.getRepeatedWrapperField(this, proto.types.Transaction, 1));
};
...
proto.types.TransactionListWithProof.prototype.getEventsForVersions = function () {
    return /** @type{?proto.types.EventsForVersions} */ (jspb.Message.getWrapperField(this, events_pb.EventsForVersions, 2));
};
...
proto.types.TransactionListWithProof.prototype.getProof = function () {
    return /** @type{?proto.types.TransactionListProof} */ (jspb.Message.getWrapperField(this, proof_pb.TransactionListProof, 4));
};
