export default {
    ...
    'Create VcoinWallet':'创建Vcoin钱包',
    'Input Nickname':'请输入昵称',
    'Input Wallet Access Code':'请输入钱包密码',
    'Confirm Wallet Access Code':'再次确认钱包密码',
    'Create BitcoinWallet':'创建Bitcoin钱包',
    'Create LiboneWallet':'创建Libone钱包',
    'Import VcoinWallet':'导入Vcoin钱包',
    'Import LiboneWallet':'导入Libone钱包',
    ...
    'Confirm  Access Code':'再次确认密码',
    'Start Import':'开始导入',
    'Import BitcoinWallet':'导入Bitcoin钱包',
    'Import LiboneWalle':'导入Libone钱包',
    'Add Address':'添加地址',
    'Note':'备注',
    'Address':'地址',
